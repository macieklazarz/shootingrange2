...
from wyniki.views import (wyniki_edycja, wyniki_dynamic_edycja,  wyniki, wyniki_general, exportexcel, exportexceldynamic, exportexcelgeneralka,  WynikUpdateView, WynikDynamicUpdateView, not_authorized, RejestracjaNaZawodyView,  RejestracjaNaZawodyDynamicView, KonkurencjaDeleteView, KonkurencjaDynamicDeleteView, TurniejListView, TurniejDeleteView, TurniejEditView, TurniejCreateView, OplataListView, OplataDynamicListView, OplataUpdateView, OplataDynamicUpdateView, UczestnikDeleteView, BronAmunicjaListView, rejestracja_choose, paymentComplete)
...
urlpatterns = [
    ...
    path('', paymentComplete.as_view(), name="payment_complete"),
